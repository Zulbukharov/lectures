...
//go:generate minimock -i post/internal/app.Repository -o ./internal/repository/repository_mock.go -n RepositoryMock
...
type RepositoryMock struct {
	...
	funcPut          func(p1 models.Post) (err error)
	inspectFuncPut   func(p1 models.Post)
...
func (mmPut *mRepositoryMockPut) Expect(p1 models.Post) *mRepositoryMockPut {
	...
	mmPut.defaultExpectation.params = &RepositoryMockPutParams{p1}
...
func (mmPut *mRepositoryMockPut) Inspect(f func(p1 models.Post)) *mRepositoryMockPut {
...
func (mmPut *mRepositoryMockPut) Set(f func(p1 models.Post) (err error)) *RepositoryMock {
	if mmPut.defaultExpectation != nil {
...
// Then helper
func (mmPut *mRepositoryMockPut) When(p1 models.Post) *RepositoryMockPutExpectation {
	if mmPut.mock.funcPut != nil {
		mmPut.mock.t.Fatalf("RepositoryMock.Put mock is already set by Set")
	}
	...
	expectation := &RepositoryMockPutExpectation{
		mock:   mmPut.mock,
		params: &RepositoryMockPutParams{p1},
	}
...
func (mmPut *RepositoryMock) Put(p1 models.Post) (err error) {
	...
	if mmPut.PutMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockPutParams{p1}
	...
	if mmPut.funcPut != nil {
		return mmPut.funcPut(p1)
	}
	mmPut.t.Fatalf("Unexpected call to RepositoryMock.Put. %v", p1)
	return
}
